...
class stat{
     ...
     */
    static statAddSpawn(idPokemon, isShiny, form = null){
        try {
     ...
     * @param {int} idPokemon //id pour l'index
     */
    static statAddCatch(idPokemon, isShiny, form = null){
        try {
    ...
    static embedClassement(interaction, arraySortPokemon, title, color){
    ...
    static embedStatGeneral(interaction){
        try {
    ...
    static updateNumberPossibilitySpawned(){
        try {
    ...
    static updateNumberPossibilityCatched(){
        try {
            for(let i = 1; i < nbPokemon; i++){
