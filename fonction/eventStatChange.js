...
class eventStatChange {
    //pas d'autre façon possible car ça modifie sa propre constante sinon
    static defaultStat(){
        return{
            "gen" : {
    ...
    static setNightMode(idServer, timeInSec, event){
        try{
    ...
    static maxMessageSpawn(idServer, nbMessageMax, timeInSec, event){
        try{
            if( bddEventStat[idServer] == undefined){
                createResetEventStat(idServer)
            }
    ...
    static minMessageSpawn(idServer, nbMessageMin, timeInSec, event){
        try{
            if( bddEventStat[idServer] == undefined){
                createResetEventStat(idServer)
            }
    ...
    static maxValeurChoiceEgg(idServer, valeurMax, timeInSec, event){
        try{
            if( bddEventStat[idServer] == undefined){
                createResetEventStat(idServer)
            }
    ...
    static specificPokemonSpawn(idServer, pokemonId, timeInSec, event){
        try{
            if( bddEventStat[idServer] == undefined){
                createResetEventStat(idServer)
            }
    ...
    static megaAllow(idServer, timeInSec, event){
        try{
            if( bddEventStat[idServer] == undefined){
                createResetEventStat(idServer)
            }
    ...
    static changeRarity(idServer,theRarityChoice, valueLessAll, timeInSec, event){
        try{
    ...
    static changeType(idServer,theTypeChoice, valueLessAll, timeInSec, event){
        try{
    ...
    static changeGen(idServer,theGenChoice, valueLessAll, timeInSec, event){
        try{
    ...
    static changeShiny(idServer, valueToDivise, timeInSec, event){
        try{
            if( bddEventStat[idServer] == undefined){
                createResetEventStat(idServer)
            }
    ...
    static createResetEventStat(idServer){
        try{
    ...
    static getGeneralStat(idServer, generalStat){
        try{
            if( bddEventStat[idServer] == undefined){
                createResetEventStat(idServer)
            }
    ...
    static getStat(idServer, generalStat, specificStat){
        try{
            if( bddEventStat[idServer] == undefined){
                createResetEventStat(idServer)
            }
...
module.exports = eventStatChange