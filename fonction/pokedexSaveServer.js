...
class pokedexSaveServer {
     ...
     */
    static pokedex(idPokemon, idServer){
        try {
    ...
    static createSaveServer(idServerCreate){
        try {
    ...
    static hasCharmChroma(idServerCreate, message){
        try {
            if(pokedexBDD[idServerCreate] === undefined){
    ...
    static getCountNational(idServer){
        try {
            countPokemon = 0;
            if(pokedexBDD[idServer] === undefined){
                createSaveServer(idServer)
    ...
    static getPercentageNational(idServer){
        try {
    ...
    static updateNumberPossibilitySave(idServerUpdate){
        try {
...
module.exports= pokedexSaveServer