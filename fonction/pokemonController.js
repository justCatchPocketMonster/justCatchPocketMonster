...
class pokemonController {
     ...
     */
    static embedPokemon(Discord, message, pokemon, Client, idChannel, isShiny){
     ...
     * @param {*} Client 
     */
    static spawnPokemon(Discord, message, Client){
        try {
     ...
     * @returns 
     */
    static catchPokemon(Discord, interaction, Client, optionString){
    ...
    static choiceTypeOfSpawn(Discord, message, pokemon, idChannel, Client, idServer){
     ...
     */
    static embedPokemonSaveUser(Discord, interaction, Client, pageChoice){
    ...
    static howThisPokemon(Discord, interaction, pokemonName, pokemonId){
